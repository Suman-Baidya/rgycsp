   ...
   return (
      <section className="py-24 bg-zinc-950 text-white overflow-hidden relative">
         ...
         <div className="max-w-7xl mx-auto px-6 mb-16 text-center relative z-10">
            <div className="inline-flex items-center justify-center gap-2 text-primary font-bold tracking-widest text-xs uppercase w-full mb-6">
            ...
            <div className="relative flex max-w-full overflow-hidden">
               <div className="flex w-max animate-marquee whitespace-nowrap">
                  {[...logos, ...logos].map((logo, index) => (
                     <div key={index} className="flex-shrink-0 w-[200px] mx-8 h-24 relative group">

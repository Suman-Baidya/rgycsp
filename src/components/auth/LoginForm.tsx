...
export function LoginForm({
  ...
  return (
    <div className="w-full max-w-[460px] px-4 animate-in fade-in slide-in-from-bottom-8 duration-700 relative">
      ...
      <Card className="relative rounded-[2.5rem] border border-white/60 dark:border-white/10 shadow-[0_32px_120px_-12px_rgba(0,0,0,0.2)] dark:shadow-[0_32px_120px_-12px_rgba(0,0,0,0.8)] bg-gradient-to-br from-white/95 via-white/80 to-white/95 dark:from-zinc-950/95 dark:via-zinc-900/80 dark:to-zinc-950/95 backdrop-blur-3xl overflow-hidden">
        {/* Inner top highlight for 3D effect */}
        <div className="absolute inset-x-0 top-0 h-px bg-gradient-to-r from-transparent via-white dark:via-white/20 to-transparent opacity-70" />

        {/* Progress Bar Top */}
        <div className="relative h-1.5 w-full overflow-hidden bg-slate-100/50 dark:bg-white/5 z-10">
          <div
            className={cn("h-full bg-primary transition-all duration-1000 ease-in-out relative", isLoading ? "w-full" : "w-0")}
        ...
        <CardContent className="relative p-6 md:p-8 space-y-5 z-10">
          {/* Header Section */}
          <div className="flex flex-col items-center text-center space-y-4">
            ...
            <div className="space-y-2">
              <h1 className="text-xl md:text-2xl font-bold tracking-tight text-transparent bg-clip-text bg-gradient-to-r from-slate-900 via-slate-700 to-slate-900 dark:from-white dark:via-slate-300 dark:to-white capitalize pb-1 bg-[length:200%_auto]">
                {tenantName || (isGlobal ? "ABCD Hub" : "Institute Portal")}
              </h1>
              <div className="flex items-center justify-center gap-3">
                <div className="h-px w-8 bg-gradient-to-r from-transparent to-slate-300 dark:to-white/20" />
                <p className="text-[10px] font-bold text-primary uppercase tracking-[0.25em]" style={{ color: primaryColor || undefined }}>
                  {isGlobal ? "Global Administration" : "Secured Member Login"}
                </p>
                <div className="h-px w-8 bg-gradient-to-l from-transparent to-slate-300 dark:to-white/20" />
              </div>
            </div>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div className="space-y-2">
              ...
              <div className="relative group">
                ...
                <Input
                  ...
                  className="h-12 pl-12 rounded-2xl border-slate-200 dark:border-white/10 bg-slate-50/50 dark:bg-white/5 focus:bg-white dark:focus:bg-zinc-900 focus:ring-4 focus:ring-primary/10 font-bold text-sm transition-all outline-none"
                  required
                />
              </div>
            </div>
            ...
            <div className="space-y-2">
              ...
              <div className="relative group">
                ...
                <Input
                  ...
                  className="h-12 pl-12 pr-12 rounded-2xl border-slate-200 dark:border-white/10 bg-slate-50/50 dark:bg-white/5 focus:bg-white dark:focus:bg-zinc-900 focus:ring-4 focus:ring-primary/10 font-bold text-sm transition-all outline-none"
                  required
                />
                <button
                  type="button"
            ...
            <Button
              type="submit"
              disabled={isLoading}
              className="w-full h-12 rounded-2xl font-bold uppercase text-xs tracking-widest shadow-xl transition-all duration-300 mt-1 bg-primary hover:opacity-90 active:scale-[0.98]"
              style={{ backgroundColor: primaryColor || undefined }}
            >
              {isLoading ? (
      ...
      <div className="mt-6 text-center">
        <p className="text-[11px] font-bold text-slate-500 dark:text-slate-400 tracking-tight">
          POWERED BY <span className="text-primary" style={{ color: primaryColor || undefined }}>RGYCSP PLATFORM</span> &copy; 2026
        </p>
      </div>
    </div>
  );

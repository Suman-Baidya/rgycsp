          ...
          <div className="flex flex-col sm:flex-row items-center sm:items-end gap-3.5 sm:gap-4 w-full">
            ...
            <div className="space-y-1 text-center sm:text-left flex-1 pb-1">
              <div className="flex flex-col sm:flex-row sm:items-center gap-2">
                <h1 className="text-lg sm:text-xl font-bold tracking-tight text-slate-900 dark:text-white">{name || "Administrator"}</h1>
            ...
            <Card className="border border-slate-200/80 dark:border-slate-800 shadow-sm rounded-xl overflow-hidden bg-white dark:bg-slate-900">
              <CardHeader className="bg-slate-50/70 dark:bg-slate-800/40 border-b border-slate-100 dark:border-slate-800 p-3.5 sm:p-4 flex flex-row items-center justify-between">
                <div>
                  ...
                  <CardDescription className="text-[10px] sm:text-xs text-slate-500">Update your photo and administrative personal details.</CardDescription>
                </div>
                <Button 
                  type="button"
                  variant="outline"
              ...
              <form onSubmit={handleProfileUpdate}>
                  ...
                  <div className={cn("flex flex-col sm:flex-row gap-4 sm:gap-6 items-start", !isEditingProfile && "opacity-80 pointer-events-none")}>
                    ...
                    <div className="flex-1 space-y-3 sm:space-y-4 w-full">
                      <div className="space-y-1">
                        ...
                        <div className="relative">
                          ...
                          <Input 
                            ...
                            className="pl-8 h-8 sm:h-9 text-xs rounded-lg bg-slate-50 dark:bg-slate-800/50 border-slate-200 dark:border-slate-700 font-medium"
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-3 sm:gap-4">
                        ...
                        <div className="space-y-1">
                          <Label htmlFor="username" className="text-[10px] font-bold uppercase tracking-wider text-slate-500">Username</Label>
                          <div className="relative">
                            <AtSign className="absolute left-2.5 top-1/2 -translate-y-1/2 h-3.5 w-3.5 text-slate-400 pointer-events-none" />
                            <Input 
                              id="username"
                              value={username} 
                ...
                {isEditingProfile && (
                  <CardFooter className="px-4 sm:px-5 py-3 border-t border-slate-100 dark:border-slate-800/50 bg-slate-50/50 dark:bg-slate-800/20 flex justify-end">
                    <Button 
                      type="submit" 
              ...
              <CardHeader className="bg-slate-50/70 dark:bg-slate-800/40 border-b border-slate-100 dark:border-slate-800 p-3.5 sm:p-4">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <CardDescription className="text-[10px] sm:text-xs text-slate-500">Ensure your administrative account is protected with a strong password.</CardDescription>
                  </div>
                </div>
              </CardHeader>
              <form onSubmit={handlePasswordUpdate}>
                <CardContent className="p-0">
                  <div className="grid grid-cols-1 lg:grid-cols-5">
                    ...
                    {/* Left side: Form */}
                    <div className="lg:col-span-3 p-3.5 sm:p-5 space-y-3.5">
                      <div className="space-y-1">
                        <Label htmlFor="currentPassword" className="text-[10px] font-bold uppercase tracking-wider text-slate-500">Current Password</Label>
                        <div className="relative">
                          <Fingerprint className="absolute left-2.5 top-1/2 -translate-y-1/2 h-3.5 w-3.5 text-slate-400 pointer-events-none" />
                          <Input 
                            id="currentPassword"
                            value={currentPassword} 
                            onChange={(e) => setCurrentPassword(e.target.value)} 
                            className="pl-8 pr-8 h-8 sm:h-9 text-xs rounded-lg bg-slate-50 dark:bg-slate-800/50 border-slate-200 dark:border-slate-700"
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                        <div className="space-y-1">
                          <Label htmlFor="newPassword" className="text-[10px] font-bold uppercase tracking-wider text-slate-500">New Password</Label>
                          <div className="relative">
                        ...
                        <div className="space-y-1">
                          <Label htmlFor="confirmPassword" className="text-[10px] font-bold uppercase tracking-wider text-slate-500">Confirm Password</Label>
                          <div className="relative">
                            <ShieldCheck className="absolute left-2.5 top-1/2 -translate-y-1/2 h-3.5 w-3.5 text-slate-400 pointer-events-none" />
                            <Input 
                              id="confirmPassword"
